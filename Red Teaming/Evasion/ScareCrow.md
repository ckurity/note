...
## 
```sh
$ ~/tools/ScareCrow/ScareCrow -I SharpHound.bin -domain www.example.com
...
[+] Sleep Timer set for 2800 milliseconds 
[*] Creating an Embedded Resource File
[+] Created Embedded Resource File With cmd's Properties
[*] Compiling Payload
[+] Payload Compiled
[*] Signing cmd.exe With a Fake Cert
2023/12/06 02:53:12 cmd.Run() failed with exec: "osslsigncode": executable file not found in $PATH
